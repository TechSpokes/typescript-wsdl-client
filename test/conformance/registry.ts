...
export const capabilities: CapabilityCase[] = [
  {
    ...
    fixture: "choice-union-simple/service.wsdl",
  ...
  },
  {
    ...
    fixture: "xs-union-simple-type/service.wsdl",
  ...
  },
  {
    ...
    fixture: "abstract-complex-type/service.wsdl",
    docsAnchor: "not-yet-supported",
    authority: "XML Schema 1.0",
  ...
  },
  {
    ...
    fixture: "substitution-group-element/service.wsdl",
    docsAnchor: "not-yet-supported",
    authority: "XML Schema 1.0",
  ...
  },
  {
    ...
    fixture: "multi-binding-first-soap/service.wsdl",
  ...
  },
  {
    ...
    fixture: "external-policy-reference/service.wsdl",
  ...
  },
  {
    ...
    fixture: "deep-composition-sequence/service.wsdl",
    docsAnchor: "fully-supported",
    authority: "XML Schema 1.0",
  ...
  },
  {
    ...
    status: "diagnostic",
    featureTags: ["xsd", "wildcard", "diagnostic"],
    fixture: "xs-anyattribute/service.wsdl",
    docsAnchor: "not-yet-supported",
    authority: "XML Schema 1.0",
    ...
    compile: {
      outcome: "research",
      reason: "The compiler retains xs:any particles but does not model xs:anyAttribute yet.",
    },
  },
  {
    ...
    fixture: "mtom-xop-attachment/service.wsdl",
    docsAnchor: "not-yet-supported",
    authority: "SOAP 1.1",
