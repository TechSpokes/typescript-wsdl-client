...
REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [x]`) syntax for tracking.
...
- [x] Step 1: Add a compiler test for local extension wildcard metadata
...
- [x] Step 2: Add mock-data tests for wildcard bags
...
- [x] Step 2: Run typecheck and verify the helper compiles
...
- [x] Step 1: Extend `CompiledType` with local wildcard metadata
...
- [x] Step 2: Store local wildcard metadata on complex-content extensions
...
- [x] Step 3: Preserve local wildcard metadata in shape canonicalization
...
- [x] Step 4: Run the compiler wildcard test
...
- [x] Step 1: Import the shared helpers
...
- [x] Step 2: Add a bag-name constant inside `generateTypes`
...
- [x] Step 3: Add an emitter for wildcard bags
...
- [x] Step 4: Compute local wildcard bags for normal and choice-mode interfaces
...
- [x] Step 5: Emit the bag in choice union base interfaces
...
- [x] Step 6: Emit the bag in normal interfaces
...
- [x] Step 7: Run snapshot tests to see the intentional diff
...
- [x] Step 2: Add an `attributesKey` parameter to `buildComplexSchema`
...
- [x] Step 3: Add the bag property after known attributes
...
- [x] Step 4: Pass the configured key from `generateSchemas`
...
- [x] Step 5: Run OpenAPI unit and conformance tests enough to observe failure movement
...
- [x] Step 2: Extend mock catalog types
...
- [x] Step 3: Keep wildcard-only types from returning early
...
- [x] Step 4: Add deterministic wildcard bag data
...
- [x] Step 1: Change row status and contract
...
- [x] Step 2: Strengthen client expectations
...
- [x] Step 3: Strengthen OpenAPI expectations
...
- [x] Step 4: Exercise the bag through the generated gateway
...
- [x] Step 5: Strengthen generated-test expectations
...
- [x] Step 6: Run conformance and verify failure points
...
- [x] Step 1: Regenerate the support matrix
...
- [x] Step 2: Update the explanatory `xs:anyAttribute` section
...
- [x] Step 3: Move `xs:anyAttribute` from partial to supported in the full support list
...
- [x] Step 4: Update roadmap wording
...
- [x] Step 1: Run unit tests for changed internals
...
- [x] Step 2: Run the required smoke pipeline
...
- [x] Step 4: Run full CI before release-candidate work
...
- [x] Step 3: Commit the implementation if requested by the maintainer
