...
Status: final 1.0 audit completed after `0.40.1`; ongoing as release hygiene.
...
`ROADMAP.md` must reflect the current `0.40.x` line. Choice union mode, JSON array streaming, conformance gate wiring, baseline WSDL coverage, wildcard attribute bags, dependency refreshes, and stage-specific conformance commands must be treated as shipped work before final release-candidate gates begin.
...
- `ROADMAP.md` names released `0.40.x` work accurately.
