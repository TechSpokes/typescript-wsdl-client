...
Use one fixture directory per capability when a case needs multiple files. Put the root WSDL at `test/conformance/fixtures/<capability-id>/<capability-id>.wsdl` and place imported schemas beside it.
